package com.cmesquita.technicaltest.justposts.utils

interface ModelsMapper<DTOModel, DomainModel> :
    DomainMapper<DomainModel, DTOModel>, DTOMapper<DTOModel, DomainModel>
